      ...
      <div className="container py-16 sm:py-20">
        <div ref={chartRef}>
          ...
          <div className="leader-reveal">
            <TierBranch label="Board of Directors" members={boardGroup.members} accent="#007d33" size="lg" showConnector={false} />
          </div>

          {/* Executive branch */}
          <div className="leader-reveal">
            <TierBranch label="Group Executive Board" members={execGroup.members} accent="#007d33" size="lg" breakAfter={4} />
          </div>

          {/* Senior Officers branch */}
          <div className="leader-reveal">
            <TierBranch label="Senior Officers" members={officersGroup.members} accent="#007d33" size="md" breakAfter={4} />
          </div>
